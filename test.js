...
var ASM_CONSTS = {
  126480: () => { return loadImage_(); },  
 126505: ($0, $1, $2, $3, $4, $5) => { drawImage_($0, $1, $2, $3, $4, $5); },  
 126545: () => { return _kbhit(); },  
 126566: () => { return _getch(); },  
 126587: ($0, $1) => { set_font_($0, $1); },  
 126610: ($0, $1) => { text_test_($0, $1); },  
 126634: ($0, $1, $2, $3, $4, $5, $6, $7) => { DrawText_($0, $1, $2, $3, $4, $5, $6, $7) },  
 126680: ($0) => { return bitmap_width_($0) },  
 126709: ($0) => { return bitmap_height_($0) },  
 126739: ($0) => { return CreateCompatibleDC_($0); },  
 126775: ($0, $1, $2, $3, $4, $5) => { BitBlt_($0, $1, $2, $3, $4, $5) },  
 126811: ($0, $1, $2, $3, $4, $5) => { BitBlt_($0, $1, $2, $3, $4, $5) },  
 126847: ($0, $1, $2, $3, $4, $5, $6) => { AlphaBlend_($0, $1, $2, $3, $4, $5, $6) },  
 126891: ($0) => { DeleteDC_($0); },  
 126910: () => { StopSound_() },  
 126927: ($0) => { StartSound_($0) }
};
...
var _data_buffer = Module['_data_buffer'] = 545728;
